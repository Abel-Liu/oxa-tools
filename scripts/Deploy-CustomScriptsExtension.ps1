...
Login-AzureRmAccount -EnvironmentName AzureChinaCloud -ServicePrincipal -TenantId $AadTenantId -SubscriptionName $AzureSubscriptionName -Credential $aadCredential -ErrorAction Stop
